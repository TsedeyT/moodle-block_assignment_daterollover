assignment_daterollover block for moodle

To install this block, 

1. unzip the directory assignment_daterollover
2. put the unziped assignment_daterollover directory into moodle/blocks/ and check  admin/index.php 
